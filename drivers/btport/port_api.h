...
*/
typedef int  (__cdecl tPORT_DATA_CALLBACK) (UINT16 port_handle, void *p_data, UINT16 len);
typedef void (__cdecl tPORT_CALLBACK) (UINT32 code, UINT16 port_handle);
...
/*
** Functions callable from other layers of BT stack or BT interface
*/
#ifdef __cplusplus
extern "C"
{
...
**
*******************************************************************************/
RFC_API extern int RFCOMM_CreateConnection (UINT16 uuid, UINT8 scn, BOOLEAN is_server,
...
**
*******************************************************************************/
RFC_API extern int PORT_SetEventCallback (UINT16 port_handle, tPORT_CALLBACK * p_port_cb);
...
**
*******************************************************************************/
RFC_API extern int PORT_SetDataCallback (UINT16 port_handle, tPORT_DATA_CALLBACK * p_cb);
...
**
*******************************************************************************/
RFC_API extern int PORT_CheckConnection (UINT16 handle, BD_ADDR bd_addr, UINT16 * p_lcid);
...
RFC_API extern int PORT_ClearError (UINT16 handle, UINT16 *p_errors, tPORT_STATUS * p_status);
...
**
*******************************************************************************/
RFC_API extern int PORT_ReadData (UINT16 handle, char *p_data, UINT16 max_len, UINT16 *p_len);
...
**
*******************************************************************************/
RFC_API extern int PORT_WriteData (UINT16 handle, char *p_data, UINT16 max_len, UINT16 *p_len);
