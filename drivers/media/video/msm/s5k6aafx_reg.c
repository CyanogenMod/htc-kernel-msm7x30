...
// End user init script
	...
	{S5K6AAFX_REG_WR, 0x0002},
	{S5K6AAFX_REG_WR, 0x0004},
	{S5K6AAFX_REG_WR, 0x0070},
	{S5K6AAFX_REG_WR, 0x00E0},
	{S5K6AAFX_REG_WR, 0x0146},
	{S5K6AAFX_REG_WR, 0x01AA},
	{S5K6AAFX_REG_WR, 0x020A},
	{S5K6AAFX_REG_WR, 0x0266},
	{S5K6AAFX_REG_WR, 0x02B6},
	{S5K6AAFX_REG_WR, 0x0300},
	{S5K6AAFX_REG_WR, 0x0344},
	{S5K6AAFX_REG_WR, 0x0384},
	{S5K6AAFX_REG_WR, 0x03BC},
	{S5K6AAFX_REG_WR, 0x03EC},

	{S5K6AAFX_REG_WR, 0x0000},
	{S5K6AAFX_REG_WR, 0x0001},
	{S5K6AAFX_REG_WR, 0x0002},
	{S5K6AAFX_REG_WR, 0x000A},
	{S5K6AAFX_REG_WR, 0x0078},
	{S5K6AAFX_REG_WR, 0x00E2},
	{S5K6AAFX_REG_WR, 0x0146},
	{S5K6AAFX_REG_WR, 0x01AA},
	{S5K6AAFX_REG_WR, 0x020A},
	{S5K6AAFX_REG_WR, 0x0266},
	...
	{S5K6AAFX_REG_WR, 0x0014}, /*TVAR_afit_pBaseVals[1]     7000082A */
	...
	{S5K6AAFX_REG_WR, 0x8020}, /*TVAR_afit_pBaseVals[60]    700008A0 */
	{S5K6AAFX_REG_WR, 0x0180}, /*TVAR_afit_pBaseVals[61]    700008A2 */
	{S5K6AAFX_REG_WR, 0x000A}, /*TVAR_afit_pBaseVals[62]    700008A4 */

	{S5K6AAFX_REG_WR, 0xFFFE}, /*TVAR_afit_pBaseVals[63]    700008A6 */
	{S5K6AAFX_REG_WR, 0x0028}, /*TVAR_afit_pBaseVals[64]    700008A8 */
	...
	{S5K6AAFX_REG_WR, 0x0A0F}, /*TVAR_afit_pBaseVals[95]    700008E6 */
	...
	{S5K6AAFX_REG_WR, 0x0154}, /*TVAR_afit_pBaseVals[121]   7000091A */
	...
	{S5K6AAFX_REG_WR, 0x0024}, /*TVAR_afit_pBaseVals[127]   70000926 */
	...
	{S5K6AAFX_REG_WR, 0x0505}, /*TVAR_afit_pBaseVals[158]   70000964 */
	...
	{S5K6AAFX_REG_WR, 0x0173}, /*TVAR_afit_pBaseVals[184]   70000998 */
	{S5K6AAFX_REG_WR, 0x0100}, /*TVAR_afit_pBaseVals[185]   7000099A */
	{S5K6AAFX_REG_WR, 0x8030}, /*TVAR_afit_pBaseVals[186]   7000099C */
	{S5K6AAFX_REG_WR, 0x0180}, /*TVAR_afit_pBaseVals[187]   7000099E */
	{S5K6AAFX_REG_WR, 0x0000}, /*TVAR_afit_pBaseVals[188]   700009A0 */

	{S5K6AAFX_REG_WR, 0xFFDE}, /*TVAR_afit_pBaseVals[189]   700009A2 */
	{S5K6AAFX_REG_WR, 0x0014}, /*TVAR_afit_pBaseVals[190]   700009A4 */
	...
	{S5K6AAFX_REG_WR, 0x0505}, /*TVAR_afit_pBaseVals[221]   700009E2 */
	...
	{S5K6AAFX_REG_WR, 0x0180}, /*TVAR_afit_pBaseVals[247]   70000A16 */
	{S5K6AAFX_REG_WR, 0x0100}, /*TVAR_afit_pBaseVals[248]   70000A18 */
	{S5K6AAFX_REG_WR, 0x8068}, /*TVAR_afit_pBaseVals[249]   70000A1A */
	{S5K6AAFX_REG_WR, 0x0180}, /*TVAR_afit_pBaseVals[250]   70000A1C */
	{S5K6AAFX_REG_WR, 0x0000}, /*TVAR_afit_pBaseVals[251]   70000A1E */

	{S5K6AAFX_REG_WR, 0x0000}, /*TVAR_afit_pBaseVals[252]   70000A20 */
	...
	{S5K6AAFX_REG_WR, 0x0502}, /*TVAR_afit_pBaseVals[284]   70000A60 */
	...
	{S5K6AAFX_REG_WR, 0x0180}, /*TVAR_afit_pBaseVals[310]   70000A94 */
	{S5K6AAFX_REG_WR, 0x0100}, /*TVAR_afit_pBaseVals[311]   70000A96 */
	{S5K6AAFX_REG_WR, 0x7050}, /*TVAR_afit_pBaseVals[312]   70000A98 */
...
static const struct s5k6aafx_i2c_reg_conf const clk_init_tbl[] = {
	...
	{S5K6AAFX_REG_WR, 0x0001}, /* PLL configurations */
