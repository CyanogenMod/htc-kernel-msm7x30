...
static const struct s5k6aafx_i2c_reg_conf const register_init_tbl_cob[] = {
	...
	{S5K6AAFX_REG_WR, 0x03BC},  /*03BC*/     /*03BA*/
	{S5K6AAFX_REG_WR, 0x03E8},  /*03E8*/     /*03E2*/
	{S5K6AAFX_REG_WR, 0x0396},  /*0396*/     /*039A*/
	{S5K6AAFX_REG_WR, 0x03DC},  /*03DC*/     /*03DA*/
	{S5K6AAFX_REG_WR, 0x0378},  /*0376*/     /*037A*/
	{S5K6AAFX_REG_WR, 0x03CA},  /*03CA*/     /*03CC*/
	{S5K6AAFX_REG_WR, 0x035C},  /*035A*/     /*035C*/
	{S5K6AAFX_REG_WR, 0x03AC},  /*03AC*/     /*03B2*/
	{S5K6AAFX_REG_WR, 0x0340},  /*0340*/     /*0342*/
	{S5K6AAFX_REG_WR, 0x0386},  /*0384*/     /*0380*/
	{S5K6AAFX_REG_WR, 0x031A},  /*031E*/     /*0324*/
	{S5K6AAFX_REG_WR, 0x0362},  /*0362*/     /*0364*/
	{S5K6AAFX_REG_WR, 0x02F6},  /*02F6*/     /*02F8*/
	{S5K6AAFX_REG_WR, 0x033C},  /*033E*/     /*0346*/
	{S5K6AAFX_REG_WR, 0x02DA},  /*02DA*/     /*02DC*/
	{S5K6AAFX_REG_WR, 0x0318},  /*0318*/     /*031C*/
	{S5K6AAFX_REG_WR, 0x02BE},  /*02C0*/     /*02C6*/
	{S5K6AAFX_REG_WR, 0x0300},  /*02FE*/     /*0300*/
	{S5K6AAFX_REG_WR, 0x02A4},  /*02A4*/     /*02A4*/
	{S5K6AAFX_REG_WR, 0x02EA},  /*02EA*/     /*02EA*/
	{S5K6AAFX_REG_WR, 0x0292},  /*0292*/     /*0292*/
	{S5K6AAFX_REG_WR, 0x02DA},  /*02D8*/     /*02D8*/
	{S5K6AAFX_REG_WR, 0x0282},  /*0284*/     /*0284*/
	{S5K6AAFX_REG_WR, 0x02D0},  /*02C8*/     /*02C8*/
	{S5K6AAFX_REG_WR, 0x0272},  /*0272*/     /*0270*/
	{S5K6AAFX_REG_WR, 0x02C0},  /*02BA*/     /*02B8*/
	{S5K6AAFX_REG_WR, 0x0266},  /*0268*/     /*0266*/
	{S5K6AAFX_REG_WR, 0x02C4},  /*02B0*/     /*02AE*/
	{S5K6AAFX_REG_WR, 0x025C},  /*025C*/     /*025C*/
	{S5K6AAFX_REG_WR, 0x02D2},  /*02A8*/     /*02A4*/
	{S5K6AAFX_REG_WR, 0x0252},  /*0252*/     /*024E*/
	{S5K6AAFX_REG_WR, 0x02D4},  /*02A0*/     /*029C*/
	{S5K6AAFX_REG_WR, 0x024C},  /*024C*/     /*0244*/
	{S5K6AAFX_REG_WR, 0x02AA},  /*0298*/     /*028A*/
	{S5K6AAFX_REG_WR, 0x0248},  /*0248*/     /*023E*/
	{S5K6AAFX_REG_WR, 0x0296},  /*0290*/     /*027E*/
	{S5K6AAFX_REG_WR, 0x0242},  /*0244*/     /*0234*/
	{S5K6AAFX_REG_WR, 0x028C},  /*028A*/     /*0272*/
	{S5K6AAFX_REG_WR, 0x023E},  /*023E*/     /*022A*/
	{S5K6AAFX_REG_WR, 0x0280},  /*027E*/     /*0266*/
	{S5K6AAFX_REG_WR, 0x0234},  /*0234*/     /*0220*/
	{S5K6AAFX_REG_WR, 0x0276},  /*0272*/     /*025A*/
	{S5K6AAFX_REG_WR, 0x022A},  /*022A*/     /*0218*/
	{S5K6AAFX_REG_WR, 0x026C},  /*0266*/     /*0250*/
	{S5K6AAFX_REG_WR, 0x0220},  /*0220*/     /*020E*/
	{S5K6AAFX_REG_WR, 0x0260},  /*025A*/     /*0246*/
	{S5K6AAFX_REG_WR, 0x0216},  /*0218*/     /*0206*/
	{S5K6AAFX_REG_WR, 0x0256},  /*0250*/     /*023C*/
	{S5K6AAFX_REG_WR, 0x020C},  /*020E*/     /*01FA*/
	{S5K6AAFX_REG_WR, 0x024C},  /*0246*/     /*0234*/
	{S5K6AAFX_REG_WR, 0x0202},  /*0206*/     /*01F0*/
	{S5K6AAFX_REG_WR, 0x0240},  /*023C*/     /*0228*/
	{S5K6AAFX_REG_WR, 0x01F8},  /*01FA*/     /*01E6*/
	{S5K6AAFX_REG_WR, 0x0236},  /*0234*/     /*0220*/
	{S5K6AAFX_REG_WR, 0x01EE},  /*01F0*/     /*01DE*/
	{S5K6AAFX_REG_WR, 0x022C},  /*0228*/     /*0216*/
	{S5K6AAFX_REG_WR, 0x01E4},  /*01E6*/     /*01D2*/
	{S5K6AAFX_REG_WR, 0x0220},  /*0220*/     /*020C*/
	{S5K6AAFX_REG_WR, 0x01DA},  /*01DE*/     /*01C6*/
	{S5K6AAFX_REG_WR, 0x0216},  /*0216*/     /*01FC*/
	{S5K6AAFX_REG_WR, 0x01D0},  /*01D2*/     /*01C4*/
	{S5K6AAFX_REG_WR, 0x020C},  /*020C*/     /*01EE*/
	{S5K6AAFX_REG_WR, 0x01C6},  /*01C6*/     /*01D0*/
	{S5K6AAFX_REG_WR, 0x01FC},  /*01FC*/     /*01E0*/
	{S5K6AAFX_REG_WR, 0x01C4},  /*01C4*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x01EE},  /*01EE*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x01D0},  /*01D0*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x01E0},  /*01E0*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x0000},  /*0000*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x0000},  /*0000*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x0000},  /*0000*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x0000},  /*0000*/     /*0000*/
	{S5K6AAFX_REG_WR, 0x0000},  /*0000*/     /*0000*/
	...
	{S5K6AAFX_REG_WR, 0x8040/*0x8030*/}, /*TVAR_afit_pBaseVals[186]   7000099C */
	...
	{S5K6AAFX_REG_WR, 0x8040/*0x8068*/}, /*TVAR_afit_pBaseVals[249]   70000A1A */
	...
	{S5K6AAFX_REG_WR, 0x7040/*0x7050*/}, /*TVAR_afit_pBaseVals[312]   70000A98 */
...
static const struct s5k6aafx_i2c_reg_conf const prev_snap_conf_init_tbl_cob[] = {
	...
	{S5K6AAFX_REG_WR, 0x0003},/* 0x02D4 value */
	{S5K6AAFX_REG_W_ADDL, 0x02CC},
	{S5K6AAFX_REG_WR, 0xFFF1},/* REG_3TC_PCFG_sSharpBlur */
